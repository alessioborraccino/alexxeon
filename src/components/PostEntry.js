        ...
        return (
            <div className="box has-background-white-ter has-shadow">
                ...
                <figure className="image is-16by9">
                    <iframe className="has-ratio" title={this.props.post.slug} width="640" height="360" src={youtubeEmbedUrlFromAnyYoutubeUrl(this.props.post.mainVideo.url)} allowFullScreen></iframe>
                </figure>
